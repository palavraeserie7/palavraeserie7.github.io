    ...
    container.innerHTML = `
        <div style="background:#fdfcf0; color:#1a202c; border-radius:15px; padding:45px; border:2px solid #1a202c; font-family:serif; box-shadow: 0 30px 60px rgba(0,0,0,0.4);">
            <div style="border-bottom: 4px solid #1a202c; padding-bottom:20px; text-align:center; margin-bottom:40px;">
                <h1 style="margin:0; font-size:2.5rem;">DOSSIÊ MASTER: ${d.tema}</h1>
                <div style="background:#065f46; color:white; padding:6px 20px; border-radius:50px; font-size:0.75rem; font-weight:bold; display:inline-block; margin-top:10px;">SENTINELA: ${d.score}/100 [${d.status}]</div>
            </div>
            <div style="margin-bottom:40px; background:white; padding:30px; border-radius:10px; border-left:10px solid #00cc66;">
                ...
                <p style="font-size:1.2rem; color:#b45309; font-weight:bold; margin:15px 0;">${d.m03.originais}</p>
            ...
            <div style="margin-top:40px;">
                ...
                <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:15px; margin-top:20px;">
                    ${d.camadas.slice(0, 9).map(c => `<div style="background:#f1f5f9; padding:10px; border-radius:5px; font-size:0.75rem;"><strong>${c.nome}</strong>  
